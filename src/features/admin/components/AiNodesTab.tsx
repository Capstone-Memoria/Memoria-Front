  ...
  return (
    <div className={"space-y-6"}>
      ...
      <div className={"flex items-center justify-between"}>
        <div>
          <h2 className={"text-xl font-bold text-gray-900"}>AI 노드 관리</h2>
            ...
            <div className={"space-y-4"}>
              ...
              <div className={"flex gap-3 pt-4"}>
                <Button
                  ...
                  disabled={createMutation.isPending || !createForm.url.trim()}
                  className={"flex-1"}
                >
                  ...
                  <div className={"flex items-center gap-3"}>
                    <div
                      className={cn(
                        ...
                        node.type === "IMAGE" ? "bg-blue-100" : "bg-purple-100"
                      )}
                    >
